...
class FilePaths:
    ...
    fn_char_list = 'D:\ML PROJECT\PK_TEXT_RECOGNITION\model\charList.txt'
    fn_summary = 'D:\ML PROJECT\PK_TEXT_RECOGNITION\model\summary.json'
    fn_corpus = 'D:\ML PROJECT\PK_TEXT_RECOGNITION\data\corpus.txt'
#SimpleHTR-master
...
def validate(model: Model, loader: DataLoaderPK, line_mode: bool) -> Tuple[float, float]:
    """Validates NN."""
    print('Validate NN')
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--img_file', help='Image used for inference.', type=Path, default='D:\ML PROJECT\PK_TEXT_RECOGNITION\data\pk test image3.png')
...
def main():
    ...
    # train the model
    if args.mode == 'train':
        loader = DataLoaderPK(args.data_dir, args.batch_size, fast=args.fast)
