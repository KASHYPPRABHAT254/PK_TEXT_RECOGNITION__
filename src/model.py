...
class Model:
    ...
    def setup_ctc(self) -> None:
        ...
        # word beam search decoding (see https://github.com/githubharald/CTCWordBeamSearch)
            ...
            word_chars = open('D:\ML PROJECT\PK_TEXT_RECOGNITION\model\wordCharList.txt').read().splitlines()[0]
            corpus = open('D:\ML PROJECT\PK_TEXT_RECOGNITION\data\corpus.txt').read()
    ...
    def setup_tf(self) -> Tuple[tf.compat.v1.Session, tf.compat.v1.train.Saver]:
        ...
        model_dir = 'D:\ML PROJECT\PK_TEXT_RECOGNITION\model/'
    ...
    def dump_nn_output(rnn_output: np.ndarray) -> None:
        ...
        dump_dir = 'D:\ML PROJECT\PK_TEXT_RECOGNITION'
    ...
    def save(self) -> None:
        """Save model to file."""
        self.snap_ID += 1
        self.saver.save(self.sess, 'D:\ML PROJECT\PK_TEXT_RECOGNITION\model\snapshot', global_step=self.snap_ID)
